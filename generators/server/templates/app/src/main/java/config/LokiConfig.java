...
public class LokiConfig {
    ...
    public LokiConfig(ApplicationProperties properties, Environment environment) {
        ...
        ApplicationProperties.Logging.Loki loki = properties.getLogging().getLoki();
        if (loki.getUrl()!=null) {
    ...
    public void addLokiAppender(
            LoggerContext context, ApplicationProperties.Logging.Loki lokiProperties, Environment environment) {
    ...
    private AbstractLoki4jEncoder getLoki4jEncoder(
            ApplicationProperties.Logging.Loki lokiProperties, Environment environment) {
