...
import static com.mycompany.util.AppConstants.PROFILE_TEST;
...
class CustomerControllerTest {
    ...
    void shouldFetchAllCustomers() throws Exception {
        Page<CustomerResponse> page = new PageImpl(customerList);
        PageRequest pageRequest = PageRequest.of(0, 10);
        CustomerQuery customerQuery = new CustomerQuery(pageRequest);
        given(customerService.findAllCustomers(customerQuery)).willReturn(page);
    ...
    void shouldReturn404WhenFetchingNonExistingCustomer() throws Exception {
        ...
        this.mockMvc
                ...
                .andExpect(jsonPath("$.type", is("http://api.myservice.com/errors/not-found")))
