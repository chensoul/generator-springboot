package com.mycompany.config.aop;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.mycompany.util.AppConstants;
...
public class LoggingAspect {
     ...
     */
    @Pointcut("within(com.mycompany..*.*Repository)" + " || within(com.mycompany..*.*Service)"
            + " || within(com.mycompany..*.*Controller)")
