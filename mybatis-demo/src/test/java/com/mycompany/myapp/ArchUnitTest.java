...
public class ArchUnitTest {
    ...
    void shouldFollowLayeredArchitecture() {
        noClasses()
                ...
                .should().dependOnClassesThat().areMetaAnnotatedWith(TableName.class)
    ...
    void shouldNotUseFieldInjection() {
        ArchCondition<JavaField> BE_ANNOTATED_WITH_AN_INJECTION_ANNOTATION =
    ...
    void shouldFollowNamingConvention() {
        ...
        methods()
                .that()
                .areDeclaredInClassesThat().areMetaAnnotatedWith(RestController.class)
...
//                .because("service contracts should be public interfaces and implementations should be hidden");
        ...
        classes()
                .that().resideInAPackage("com.mycompany.myapp.repository")
                .should().haveSimpleNameEndingWith("Repository");

        classes()
                .that().resideInAPackage("com.mycompany.myapp.service")
